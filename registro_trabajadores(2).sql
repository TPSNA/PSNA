...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2025 a las 17:14:21
...
CREATE TABLE `trabajadores` (
  ...
  `Tipo_trabajador` enum('CTD','LNR') NOT NULL,
  `Cargo` enum('DIRECTOR GENERAL','COORDINADOR DE PRESUPUESTO','COORDINADOR DE DESARROLLO ORGANIZACIONAL','COORDINADOR DE ARCHIVOS','COORDINADOR DE SEGURIDAD','DIRECTOR DE ASUNTOS JURIDICOS','COORDINADOR DE CONTROL Y GESTION','COORDINADOR DE TRANSPORTE','DIRECTOR TALENTO HUMANO','DIRECTOR DESARROLLO HUMANO INTEGRAL','COORDINADOR DE BIENES','DIRECTOR DE ADMINISTRACION Y FINANZAS','DIRECTOR DE REINSERCION SOCIAL','DIRECTOR DE PLANIFICACION PRESUPUESTO Y DESARROLLO ORGANIZACIONAL','DIRECTOR DE OPERACIONES','DIRECTOR DE BIENESTAR SOCIAL','COORDINADOR DE NUTRICION','DIRECTOR COMUNICACIÓN Y REDES SOCIALES','COORDINADOR DE TALENTO HUMANO','DIRECTOR DE TECNOLOGIA INFORMATICA Y TELECOMUNICACIONES','DIRECTOR DE ATENCION AL CIUDADANO','COORDINADOR DE AREA','COORDINADOR DE SERVICIOS GENERALES','DIRECTOR DE CENTRO','COORDINADOR DE CENTRO','GUIA FACILITADOR','ASISTENTE DE OFICINA','CONTADOR','ABOGADO','INSTRUCTOR DE FORMACION PROFESIONAL','CAPELLAN','MEDICO','ENFERMERA','PSICOLOGO','TRABAJADOR SOCIAL','TERAPEUTA','MANTENIMIENTO','COCINERO','VIGILANTE') NOT NULL,
