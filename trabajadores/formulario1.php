    ...
    <header class="main-header">
        <div class="header-container">
            ...
            <nav class="nav-menu" id="nav-menu">
                ...
                <a href="formulario1.php" class="nav-link active">
                ...
                <form action="../php/procesar_trabajador.php" method="POST" enctype="multipart/form-data" id="registration-form">
                    ...
                    <div class="step-content" data-step="2">
                        ...
                        <p class="step-description">
                            Proporcione los detalles laborales y administrativos del trabajador.
                        </p>
                    ...
                    <div class="step-content" data-step="3">
                        ...
                        <p class="step-description">
                            Complete la información adicional y características personales del trabajador.
                        </p>
                    ...
                    <div class="step-content" data-step="5">
                        ...
                        <p class="step-description">
                            Suba una fotografía del trabajador. Formatos aceptados: JPG, PNG. Tamaño máximo: 5MB.
                        </p>
