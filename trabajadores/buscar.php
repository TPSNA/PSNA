...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Radio buttons personalizados para ubicación */
        .radio-group {
            display: flex;
            flex-direction: column;
            gap: 10px;
    ...
    <header class="main-header">
        <div class="header-container">
            ...
            <nav class="nav-menu" id="nav-menu">
                ...
                <a href="buscar.php" class="nav-link active">  <!-- active en Buscar -->
        ...
        <div class="search-form-container">
            <form method="GET" action="index.php">
                ...
                <div class="form-section">
                    <div class="section-title">
                        ...
                        <h2>Filtros Especiales</h2>
                    </div>
                    
                    <div class="form-grid">
                        <!-- FILTRO DE CAMPOS VACÍOS (SIMPLIFICADO) -->
                        <div class="form-group">
                            <div class="checkbox-wrapper">
                                <input type="checkbox" id="campos_vacios" name="campos_vacios" value="1">
                                <label for="campos_vacios">
                                    <i class="fas fa-exclamation-triangle"></i> Mostrar solo registros con campos vacíos
                                </label>
                            </div>
                            <div class="field-info">Busca trabajadores con información incompleta en cualquier campo importante</div>
                        </div>
                        
                        <!-- FILTRO DE UBICACIÓN DE EXPEDIENTE (SIMPLIFICADO) -->
                        <div class="form-group">
                            <label><i class="fas fa-archive"></i> Ubicación del expediente físico</label>
                            <div class="radio-group">
                                <div class="radio-option">
                                    <input type="radio" id="ubicacion_todos" name="ubicacion_expediente" value="todos" checked>
                                    <label for="ubicacion_todos">Todos (con y sin ubicación)</label>
                                </div>
                                <div class="radio-option">
                                    <input type="radio" id="ubicacion_sin" name="ubicacion_expediente" value="sin">
                                    <label for="ubicacion_sin">
                                        <i class="fas fa-map-marker-alt"></i> Sin ubicación asignada
                                    </label>
                                </div>
                                <div class="radio-option">
                                    <input type="radio" id="ubicacion_con" name="ubicacion_expediente" value="con">
                                    <label for="ubicacion_con">
                                        <i class="fas fa-map-marker-alt"></i> Con ubicación asignada
                                    </label>
                                </div>
                            </div>
                            <div class="field-info">Filtra por expedientes que tienen o no tienen ubicación física asignada</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="search-tips">
                ...
                <ul class="tips-list">
                    ...
                    <li><i class="fas fa-check-circle"></i> Marca "campos vacíos" para encontrar registros incompletos</li>
                    <li><i class="fas fa-check-circle"></i> Usa el botón "Limpiar" para reiniciar todos los filtros</li>
                </ul>
            </div>
        </div>
    </div>
